        ...
        <div class="navbar-custom-menu">
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="<?= Url::base()?>/images/admin-pro-temp.jpg" class="user-image" alt="User Image"/>
                        <span class="hidden-xs">Sagor Al Mamun</span>
                    </a>
                    <ul class="dropdown-menu">
                        <!-- User image -->
                        <li class="user-header">
                            <img src="<?= Url::base()?>/images/admin-pro-temp.jpg" class="img-circle"
                                 alt="User Image"/>
